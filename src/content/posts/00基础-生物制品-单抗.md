...
![|525](/images/00基础-生物制品-单抗/1103 Immunological test methods-Enzyme-linked immunosorbent assay-1.webp)![|759](/images/00基础-生物制品-单抗/1103 Immunological test methods-Enzyme-linked immunosorbent assay-2.webp)
**Sandwich ELISA**
...
![|525](/images/00基础-生物制品-单抗/1103 Immunological test methods-Enzyme-linked immunosorbent assay-3.webp)
...
## 1.抗体结构
### 可变区
抗体上结合抗原的部分：paratope或comple- mentarity-deter-min- regions (CDRs)；
...
### 铰链区
![|499](/images/00基础-生物制品-单抗/hinge-sequence.webp)
...
![|447](/images/00基础-生物制品-单抗/IgG&MMP.webp)
...
- ADCC
	...
	- engineering the Fc domain
		- S298A, K334A, E333A, and T256A，增加对FcγRIIIa的亲和力[^2]；
- CDC
	- anti-CD20 Rituximab: 突变K326 and E333位点[^3]；
	- 调节铰链区middle region的长度[^4]
...
Human mAbs：利用转基因小鼠[^5]或噬菌体展示技术[^6]；首款人源单抗-Adalimumab(Trade name: Humira)，采用噬菌体展示技术，于2002年上市；
...
## Reference
[^1]: Selective cleavage of human IgG by the matrix metalloproteinases, matrilysin and stromelysin；- DOI: [10.1016/s0165-2478(01)00333-9](https://doi.org/10.1016/s0165-2478(01)00333-9)
[^2]: High resolution mapping of the binding site on human IgG1 for Fc gamma RI, Fc gamma RII, Fc gamma RIII, and FcRn and design of IgG1 variants with improved binding to the Fc gamma R - DOI: [10.1074/jbc.M009483200](https://doi.org/10.1074/jbc.m009483200)
[^3]: Engineered antibodies with in- creased activity to recruit complement. Journal of Immunology
[^4]: Modulation of the effector functions of a human IgG1 through engineering of its hinge region. Journal of Immunology. 2006;177(2):1129–1138.
[^5]: Molecular insights into fully human and humanized monoclonal antibodies: What are the differences and should dermatologists care?
[^6]: Phage dis- play for the generation of antibodies for proteome research, diagnostics and therapy. Molecules (Basel, Switzerland). 2011;16(1):412–426.
## 相关笔记
...
抗体修饰PTM对其结构，稳定性和生物性质有深远的影响[^1]；从监管机构的角度看，鉴定单抗上的PTM，并对PTM进行定位，不仅有助于理解蛋白结构和功能，还有助于鉴定影响总体纯度、活性和其他质量属性的非期望产物和降解物；
...
> It is expected that the manufacturer should define the pattern of heterogeneity of the desired product and demonstrate consis- tency between lots used in preclinical and clinical studies.

### 2.1 Glycan heterogeneity
糖基化引入相当大的异质性；
糖基化的影响：
...
### 2.2 Size heterogeneity

high molecular weight (HMW) species/aggregates and low molecular weight (LMW) species/ fragments/degradants
...
- 色谱：分离基于表面电荷；基于分离时间定义酸性组分和碱性组分；
	- CEX(阳离子交换)[^5] [^6] ：<font color="#ff0000">文献重要</font>
		- 出峰顺序，酸性峰-主峰-碱性峰；
		- 适用于抗体的电荷变体定性和定量分析；
...
- 电泳：分离基于整体净电荷；基于pI定义酸性组分和碱性组分
	...
	- capillary zone electrophoresis (CZE)[^8] [^9]
		- 毛细管
		...
		- 使用场景：He Y[^9]开发的CZE适用于**pI大于7的抗体**；对于pI较低的蛋白，需要方法开发；
...
Simultaneous monitoring of oxidation, deamidation, isomerization, and glycosylation of monoclonal antibodies by liquid chro- matography-mass spectrometry method with ultrafast tryptic digestion. mAbs. 2016;8(8):1477–1486.
...
[^1]:Characterization of glycosylation in monoclonal antibodies and its importance in therapeutic antibody development. Critical Reviews in Biotechnology. 2021a;4- 1(2):300–315.
[^2]: Analytical similarity assessment of ritux- imab biosimilar CT-P10 to reference medicinal product. mAbs. 2018;10(3):380–396
[^3]: Rapid characterization of biotherapeutic proteins by size-exclusion chromatography coupled to native mass spectrometry. mAbs. 2016;8(2):331–339
[^4]: Optimization and validation of a quantitative capillary electrophoresis sodium dodecyl sulfate method for quality control and stability monitoring of monoclonal antibodies. Analytical Chemistry. 2006;78(18):6583–6594.
[^5]: Method development for the separation of monoclonal antibody charge variants in cation exchange chromatography, part I: salt gradient approach. Journal of Pharmaceutical and Biomedical Analysis. 2015a;102:33–44.
[^6]: Method development for the separation of monoclonal antibody charge variants in cation exchange chromatography, part II: pH gradient approach. Journal of Pharmaceutical and Biomedical Analysis. 2015b;102:282–289.
[^7]:  Intercompany study to evaluate the robustness of capillary isoelectric focusing technology for the analysis of monoclonal antibodies. Chromatographia. 2011;73:1137–1144
[^8]: Analysis of recombinant monoclonal antibodies by capillary zone electrophoresis. Electrophoresis. 2013;34(8):1133–1140.
[^9]: He Y, Isele C, Hou W, Ruesch M. Rapid analysis of charge variants of monoclonal antibodies with capillary zone electrophoresis in dynamically coated fused-silica capillary. J Sep Sci. 2011;34:548-55. [https://doi.org/10.1002/jssc.201000719](https://doi.org/10.1002/jssc.201000719)
[^10]: Accuracy of protein secondary structure determination from circular dichroism spectra based on immunoglobulin examples. Analytical Biochemistry. 2003;321(2):183–187.
## 相关笔记
...
> [!quote] **链接**
> 1. [Chapter 1—Antibody-dependent cel- lular cytotoxicity (ADCC)](https://reader-service.fcdn.sk/?source=5a526cd179f8a55ed4d02cd34ac5db97ec6ac428920ba23e5678912ef238658f&download_link=https%3A%2F%2Fzh.z-lib.fo%2Fdl%2F2204832%2F9d7dff)
...
### 1. Types of Biotherapeutics and Manufacturing Systems
**蛋白药物分类**[^1]
![](/images/00基础-生物制品-单抗/Chapter1 Introduction to Biotherapeutics-classification.webp)
...
>[!abstract] 摘要
>本笔记是 Antibody-Characterization 文件夹的索引/MOC（Map of Content），按主题（质谱工具与Protocol、蛋白组学与肽图、Size/Charge/Sequence variant表征、糖基化、聚集、PTM表征、专题稳定性与断裂、成药性评价、经典书籍章节研读等）组织并链接至具体笔记与文献解读，方便按主题快速定位相关内容。

### 1.基础
1. DTT or TCEP
2. [CID碎裂-proline effect](/posts/05仪器与分析技术-质谱)
...
------
### 4.Proteomics and peptide mapping
**蛋白组学blog**：[https://proteomicsnews.blogspot.com/](https://proteomicsnews.blogspot.com/)
1. [Mascot training](/posts/05仪器与分析技术-质谱)
2. [protein sequencing与离子类型](/posts/05仪器与分析技术-质谱)
3. 蛋白酶
4. 前处理/肽图-样品前处理
5. 前处理/去污剂去除
6. 蛋白组学质谱
多肽碎裂：[https://www.uab.edu/proteomics/pdf_files/2011/BMG744-01-14-11.pdf](https://www.uab.edu/proteomics/pdf_files/2011/BMG744-01-14-11.pdf)


----
### 5.Size-variant characterization
1. Size Exclusion Chromatography
2. A review size-exclusion chromatography for the analysis of protein biotherapeutics and their aggregations
3. 减少SEC分析中的次级相互作用-流动相优化
4. SEC色谱柱
...
[https://books.google.com.sg/books?hl=en&lr=&id=LcWPDwAAQBAJ&oi=fnd&pg=PA133&dq=Size-exclusion+chromatography+antibody&ots=i6ZSSxnuDr&sig=Ch2MUf3N6ToI9wPbkeSZIyOHH7Y#v=onepage&q=Size-exclusion%20chromatography%20antibody&f=false](https://books.google.com.sg/books?hl=en&lr=&id=LcWPDwAAQBAJ&oi=fnd&pg=PA133&dq=Size-exclusion+chromatography+antibody&ots=i6ZSSxnuDr&sig=Ch2MUf3N6ToI9wPbkeSZIyOHH7Y#v=onepage&q=Size-exclusion%20chromatography%20antibody&f=false)

-----
### 6.Charge variant characterization
1. Charge variants电荷异质体
...
2. [Monoclonal Antibody Development and Physicochemical Characterization by High Performance Ion Exchange Chromatography | IntechOpen](https://www.intechopen.com/chapters/28723)
 书籍： Innovations in Biotechnology


-----
### 7.Sequence variants
1. Detecting low level sequence variants in recombinant monoclonal antibodies -   DOI: [10.4161/mabs.2.3.11718](https://doi.org/10.4161/mabs.2.3.11718)
...
### 8.Glycosylation
1.  糖基化-Pert1.基础篇：糖生物学
2. 糖基化-Part2.结构与功能
3. 糖基化-Part3.表征方法
4. Characterization of Site-Specific N-Glycosylation
5. 18O-labeling(N-linked site mapping)
6. [PNGaseF](/posts/02分子表征-ptm)
7. 前处理/脱糖方法
8. 脱糖相关酶
9. 基于质谱的唾液酸异构体区分及其定量
...
----
### 9.Aggregation
1.  Classification and characterization of therapeutic antibody aggregates  -   DOI: [10.1074/jbc.M110.160457](https://doi.org/10.1074/jbc.m110.160457)
2. Cromwell, M. E. M.; Hilario, E.; Jacobson, F. Protein Aggregation and Bioprocessing. AAPS J 2006, 8 (3), E572–E579.


-----
### 10.PTM characterization
1. [PTM](/posts/02分子表征-ptm)
2. [抗体常见修饰](/posts/02分子表征-ptm)
3. 二硫键
...
1. Isomerization分析表征
2. Glycation分析表征
3. Cys-linked variants分析表征


------
### 12.稳定性
文献：Stability of Protein Pharmaceuticals: An Update
Physicochemical Stability of Monoclonal Antibodies : A Review Check for updates
...
-----
### 14.成药性评价
成药性Bailly M, Mieczkowski C, Juan V, et al. Predicting Antibody Developability Profiles Through Early Stage Discovery Screening. MAbs. 2020;12(1):1743053.
...
-----
### 16.定量
1. Quantification of protein posttranslational modifications using stable isotope and mass spectrometry I: principles and applications -   DOI: [10.1016/j.ab.2011.12.004](https://doi.org/10.1016/j.ab.2011.12.004)
2. Quantification of protein posttranslational modifications using stable isotope and mass spectrometry. II. Performance  -   DOI: [10.1016/j.ab.2011.12.003](https://doi.org/10.1016/j.ab.2011.12.003)
...
-----
### 18.经典书籍研读
#### 1.《Analytical characterization of biotherapeutics》


#### 2.《Characterization of Protein Therapeutics  using Mass Spectrometry》
1.  Characteriation of protein therapeutics using mass spectrometry/Chapter1 Introduction to protein mass spectrometry
2. Characteriation of protein therapeutics using mass spectrometry/Chapter2 Quantitative Analysis of Therapeutic  and Endogenous Peptides using  LC-MSMS Methods
3. MS-Based Bioanalytical Methods for the Quantification of Protein Therapeutics in Drug Discovery
4. Characteriation of protein therapeutics using mass spectrometry/Chapter4 Post-Translationally Modified Proteins  Glycosylation and Disulfide Bond Formation
5. Characteriation of protein therapeutics using mass spectrometry/Chapter5 Mass Spectrometric Characterization in Protein Therapeutics Discovery
6. Molecular Variants Characterization in Protein Therapeutics Development
7. Mass Spectrometry of Antibody–Drug Conjugates in Plasma and Tissue in Drug Development
8. Chapter 8 Deuterium Exchange Mass Spectrometry for Protein Higher-Order Structure Characterization
9. Fast Photochemical Oxidation of Proteins for Structural Characterization
10. Applications of Ion Mobility Mass Spectrometry for Characterization of Protein Therapeutics

#### 3.《State-of-the-Art and Emerging  Technologies for Therapeutic  Monoclonal Antibody Characterization  Volume 1. Monoclonal Antibody  Therapeutics: Structure, Function, and  Regulatory Space》
1.Monoclonal Antibody Therapeutics The Need for Biopharmaceutical Reference Materials
2.


#### 4.Volume 2. Biopharmaceutical Characterization: The NISTmAb Case Study
1. Chapter1 Determination of the NISTmAb Primary Structure
2. Volume 2 Biopharmaceutical Characterization The NISTmAb Case Study/Chapter2 Sequence Variants and Sequence Variant Analysis in Biotherapeutic Proteins
3. Chapter 3 Structural Elucidation of Post-Translational Modifications in Monoclonal Antibodies
4. Chapter4 Orthogonal Technologies for NISTmAb N-Glycan Structure Elucidation and Quantitation
5. Chapter 5 Separation Methods and Orthogonal Techniques
6. [Chapter6_Biophysical Techniques for Characterizing the Higher Order Structure](Volume%202%20Biopharmaceutical%20Characterization%20The%20NISTmAb%20Case%20Study/Chapter6_Biophysical%20Techniques%20for%20Characterizing%20the%20Higher%20Order%20Structure.md)
7. Chapter 7 Developability Assessment of a Proposed NIST Monoclonal Antibody
8. [Chapter 8 Protein Particles (0.1 µm to 100 µm)](Antibody-Characterization/Volume%202%20Biopharmaceutical%20Characterization%20The%20NISTmAb%20Case%20Study/Chapter%208%20Protein%20Particles%20(0.1%20µm%20to%20100%20µm).md)
9. [Chapter9 Analytical Methods for the Measurement of Host Cell Proteins and Other Process-Related Impurities](Antibody-Characterization/Volume%202%20Biopharmaceutical%20Characterization%20The%20NISTmAb%20Case%20Study/Chapter9%20Analytical%20Methods%20for%20the%20Measurement%20of%20Host%20Cell%20Proteins%20and%20Other%20Process-Related%20Impurities.md)

#### 5. protein sequencing and identification using tandem mass spectrometry
1. [Chapter 1 An Introduction to Protein Sequencing Using  Tandem Mass Spectrometry](Antibody-Characterization/protein%20sequencing%20and%20identification%20using%20tandem%20mass%20spectrometry/Chapter%201%20An%20Introduction%20to%20Protein%20Sequencing%20Using%20%20Tandem%20Mass%20Spectrometry.md)


-------

### 19.其它
1. C-tag affinity tag(Epitope tagging)
2. Labchip
3. lunatic原理和使用
4. Protocol for in-SDS polyacrylamide gel protein digestion with ALS
5. QC检测流程梳理
6. SDS-PAGE与artifact bands
7. 缓冲盐介绍
8. 前处理/脱盐处理
9. 大牛文献集
...
电荷变体来源于细胞培养/发酵过程中的酶促与非酶促PTM、下游加工及储存中的降解。[^1]
...
**高表达时的问题**：MAP饱和或缺乏 Co²⁺/Mn²⁺ cofactor → N端异质性，fMet保留蛋白因α-氨基被甲酰基封闭而**偏向酸性**。[^2][^3][^4]
...
> [!example] 实验证据
> Rajagopalan等（2004）证明，加入PDF抑制剂 actinonin 后，*E. coli* 重组蛋白大量保留甲酰基，形成独立的**酸性前峰**。[^4]

#### 2.1.2 N端焦谷氨酸（pyroGlu）形成
...
> [!tip] 关键区分
> Dick等（2007）证明：质量变化相同（−17 Da），但 **来源于Gln→酸性峰**，**来源于Glu→碱性峰**。[^5][^6]
...
以大肠杆菌表达的重组人生长激素（rhGH）为例：在40°C加速降解及4°C长期储存中，脱酰胺组分（I4）比例显著增加，CEX分析中表现为**酸性前峰**。[^8][^9]
...
> [!example] 关键文献
> Becker等（1991）从 *E. coli* 表达的**甲硫氨酰-人生长激素（met-hGH）**中，首次分离出琥珀酰亚胺变体，经AEX分离为==碱性后峰==。[^10]
...
- Quan等（2019）证明，降低培养氧化应激可减少糖化及酸性变体比例[^12]
...
### 2.7 赖氨酸酰化（*E. coli* 内源PTM）

#### 2.7.1 赖氨酸乙酰化（Kac）

- Nε-乙酰化中和 Lys 正电荷（+1→0），质量 +42 Da → ==**酸性变体**==
- Weinert等（2013）在野生型 *E. coli* 鉴定 **782种蛋白的2803个Kac位点**[^13]

#### 2.7.2 赖氨酸琥珀酰化（Ksuc）

- 将 Lys ε-NH₃⁺（+1）转变为带负电的琥珀酰胺（−1），净变化 **−2**
- 质量 +100 Da，是最强的酸性偏移赖氨酸修饰
- Zhang等（2011）在 *Nature Chemical Biology* 首次鉴定，*E. coli* 中 670种蛋白的 2580个位点[^14]
...
> [!info] 参考
> 关于 *E. coli* 二硫键形成机制，见 Jurado等（2011）综述[^15]。
...
- Charge variants电荷异质体 — IEX分析方法与文献汇总
- [PTM](/posts/02分子表征-ptm) — PTM总体概述与修饰数据库
- Peptide mapping — 肽图LC-MS方法，用于PTM位点鉴定
- Antibody-Characterization总目录 — 表征总目录
